...
* <pre>
* var VersifyApi = require('index'); // See note below*.
* var xxxSvc = new VersifyApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new VersifyApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new VersifyApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new VersifyApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
