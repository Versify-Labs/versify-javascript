...
export default class ClaimsApi {
    ...
    */
     ...
     */
    createClaimV2ClaimsPost(asset1, opts, callback) {
      opts = opts || {};
      let postBody = asset1;
      // verify the required parameter 'asset1' is set
      if (asset1 === undefined || asset1 === null) {
        throw new Error("Missing the required parameter 'asset1' when calling createClaimV2ClaimsPost");
      }
     ...
     * data is of type: {@link module:model/Claim}
     */
    createClaimV2ClaimsPost_0(asset1, opts, callback) {
      opts = opts || {};
      let postBody = asset1;
      // verify the required parameter 'asset1' is set
      if (asset1 === undefined || asset1 === null) {
        throw new Error("Missing the required parameter 'asset1' when calling createClaimV2ClaimsPost_0");
      }
