...
export default class RedemptionsApi {
    ...
    */
     ...
     */
    createRedemptionV2RedemptionsPost(asset8, opts, callback) {
      opts = opts || {};
      let postBody = asset8;
      // verify the required parameter 'asset8' is set
      if (asset8 === undefined || asset8 === null) {
        throw new Error("Missing the required parameter 'asset8' when calling createRedemptionV2RedemptionsPost");
      }
     ...
     * data is of type: {@link module:model/Redemption}
     */
    createRedemptionV2RedemptionsPost_0(asset8, opts, callback) {
      opts = opts || {};
      let postBody = asset8;
      // verify the required parameter 'asset8' is set
      if (asset8 === undefined || asset8 === null) {
        throw new Error("Missing the required parameter 'asset8' when calling createRedemptionV2RedemptionsPost_0");
      }
     ...
     * data is of type: {@link module:model/Redemption}
     */
    updateRedemptionV2RedemptionsRedemptionIdPut(redemptionId, contact9, opts, callback) {
      opts = opts || {};
      ...
      if (contact9 === undefined || contact9 === null) {
        throw new Error("Missing the required parameter 'contact9' when calling updateRedemptionV2RedemptionsRedemptionIdPut");
      }
     ...
     * data is of type: {@link module:model/Redemption}
     */
    updateRedemptionV2RedemptionsRedemptionIdPut_0(redemptionId, contact9, opts, callback) {
      opts = opts || {};
      let postBody = contact9;
      // verify the required parameter 'redemptionId' is set
      if (redemptionId === undefined || redemptionId === null) {
      ...
      // verify the required parameter 'contact9' is set
      if (contact9 === undefined || contact9 === null) {
        throw new Error("Missing the required parameter 'contact9' when calling updateRedemptionV2RedemptionsRedemptionIdPut_0");
      }
