...
export default class CollectionsApi {
    ...
    */
     ...
     */
    createCollectionV2CollectionsPost(asset3, opts, callback) {
      opts = opts || {};
      let postBody = asset3;
      // verify the required parameter 'asset3' is set
      if (asset3 === undefined || asset3 === null) {
        throw new Error("Missing the required parameter 'asset3' when calling createCollectionV2CollectionsPost");
      }
     ...
     * data is of type: {@link module:model/Collection}
     */
    createCollectionV2CollectionsPost_0(asset3, opts, callback) {
      opts = opts || {};
      let postBody = asset3;
      // verify the required parameter 'asset3' is set
      if (asset3 === undefined || asset3 === null) {
        throw new Error("Missing the required parameter 'asset3' when calling createCollectionV2CollectionsPost_0");
      }
