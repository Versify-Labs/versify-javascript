...
export default class MintsApi {
    ...
    */
     ...
     */
    createMintV2MintsPost(asset6, opts, callback) {
      opts = opts || {};
      let postBody = asset6;
      // verify the required parameter 'asset6' is set
      if (asset6 === undefined || asset6 === null) {
        throw new Error("Missing the required parameter 'asset6' when calling createMintV2MintsPost");
      }
     ...
     * data is of type: {@link module:model/Mint}
     */
    createMintV2MintsPost_0(asset6, opts, callback) {
      opts = opts || {};
      let postBody = asset6;
      // verify the required parameter 'asset6' is set
      if (asset6 === undefined || asset6 === null) {
        throw new Error("Missing the required parameter 'asset6' when calling createMintV2MintsPost_0");
      }
     ...
     * data is of type: {@link module:model/Mint}
     */
    updateMintV2MintsMintIdPut(mintId, contact7, opts, callback) {
      opts = opts || {};
      ...
      if (contact7 === undefined || contact7 === null) {
        throw new Error("Missing the required parameter 'contact7' when calling updateMintV2MintsMintIdPut");
      }
     ...
     * data is of type: {@link module:model/Mint}
     */
    updateMintV2MintsMintIdPut_0(mintId, contact7, opts, callback) {
      opts = opts || {};
      let postBody = contact7;
      // verify the required parameter 'mintId' is set
      if (mintId === undefined || mintId === null) {
      ...
      // verify the required parameter 'contact7' is set
      if (contact7 === undefined || contact7 === null) {
        throw new Error("Missing the required parameter 'contact7' when calling updateMintV2MintsMintIdPut_0");
      }
