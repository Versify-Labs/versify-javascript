...
export default class RewardsApi {
    ...
    */
     ...
     */
    createRewardV2RewardsPost(asset9, opts, callback) {
      opts = opts || {};
      let postBody = asset9;
      // verify the required parameter 'asset9' is set
      if (asset9 === undefined || asset9 === null) {
        throw new Error("Missing the required parameter 'asset9' when calling createRewardV2RewardsPost");
      }
     ...
     * data is of type: {@link module:model/Reward}
     */
    createRewardV2RewardsPost_0(asset9, opts, callback) {
      opts = opts || {};
      let postBody = asset9;
      // verify the required parameter 'asset9' is set
      if (asset9 === undefined || asset9 === null) {
        throw new Error("Missing the required parameter 'asset9' when calling createRewardV2RewardsPost_0");
      }
     ...
     * data is of type: {@link module:model/Reward}
     */
    updateRewardV2RewardsRewardIdPut(rewardId, contact10, opts, callback) {
      opts = opts || {};
      ...
      if (contact10 === undefined || contact10 === null) {
        throw new Error("Missing the required parameter 'contact10' when calling updateRewardV2RewardsRewardIdPut");
      }
     ...
     * data is of type: {@link module:model/Reward}
     */
    updateRewardV2RewardsRewardIdPut_0(rewardId, contact10, opts, callback) {
      opts = opts || {};
      let postBody = contact10;
      // verify the required parameter 'rewardId' is set
      if (rewardId === undefined || rewardId === null) {
      ...
      // verify the required parameter 'contact10' is set
      if (contact10 === undefined || contact10 === null) {
        throw new Error("Missing the required parameter 'contact10' when calling updateRewardV2RewardsRewardIdPut_0");
      }
