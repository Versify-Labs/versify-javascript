...
/**
 * The BrandSettings model module.
 * @module model/BrandSettings
 * @version 1.0.0
 */
class BrandSettings {
    /**
     * Constructs a new <code>BrandSettings</code>.
     * The brand settings for the account
     * @alias module:model/BrandSettings
     * @implements module:model/Brand
     */
    constructor() { 
        Brand.initialize(this);
        BrandSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BrandSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BrandSettings} obj Optional instance to populate.
     * @return {module:model/BrandSettings} The populated <code>BrandSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BrandSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>BrandSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BrandSettings</code>.
     */
 ...
 * @default '#000000'
 */
BrandSettings.prototype['action_color'] = '#000000';
 ...
 * @default '#000000'
 */
BrandSettings.prototype['background_color'] = '#000000';

/**
 * The URL of the brand's logo
 * @member {String} logo
 */
BrandSettings.prototype['logo'] = undefined;
 ...
 * @default '#000000'
 */
BrandSettings.prototype['primary_color'] = '#000000';
 ...
 * @default '#000000'
 */
BrandSettings.prototype['secondary_color'] = '#000000';
 ...
 * @default '#000000'
 */
BrandSettings.prototype['tertiary_color'] = '#000000';
 ...
 * @default '#000000'
 */
BrandSettings.prototype['wallet_action_color'] = '#000000';
 ...
 * @default 'Welcome'
 */
BrandSettings.prototype['wallet_welcome_message'] = 'Welcome';
