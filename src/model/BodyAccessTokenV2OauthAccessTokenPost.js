...
class BodyAccessTokenV2OauthAccessTokenPost {
    ...
    constructor(code, customClaims, methodId) { 
        ...
        BodyAccessTokenV2OauthAccessTokenPost.initialize(this, code, customClaims, methodId);
    }
...
BodyAccessTokenV2OauthAccessTokenPost.RequiredProperties = ["code", "custom_claims", "method_id"];
 ...
 */
BodyAccessTokenV2OauthAccessTokenPost.prototype['method_id'] = undefined;
