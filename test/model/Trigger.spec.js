...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VersifylabsVersifyClient.Trigger();
  });
  ...
  describe('Trigger', function() {
    it('should create an instance of Trigger', function() {
      ...
      //var instance = new VersifylabsVersifyClient.Trigger();
      //expect(instance).to.be.a(VersifylabsVersifyClient.Trigger);
    });
