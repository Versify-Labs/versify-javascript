...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VersifylabsVersifyClient.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new VersifylabsVersifyClient.Account();
      //expect(instance).to.be.a(VersifylabsVersifyClient.Account);
    });
