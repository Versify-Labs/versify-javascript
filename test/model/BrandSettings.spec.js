...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VersifylabsVersifyClient.BrandSettings();
  });
  ...
  describe('BrandSettings', function() {
    it('should create an instance of BrandSettings', function() {
      // uncomment below and update the code to test BrandSettings
      //var instance = new VersifylabsVersifyClient.BrandSettings();
      //expect(instance).to.be.a(VersifylabsVersifyClient.BrandSettings);
    });
