...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VersifyApi.TriggerScheduleConfig();
  });
  ...
  describe('TriggerScheduleConfig', function() {
    it('should create an instance of TriggerScheduleConfig', function() {
      ...
      //var instance = new VersifyApi.TriggerScheduleConfig();
      //expect(instance).to.be.a(VersifyApi.TriggerScheduleConfig);
    });
