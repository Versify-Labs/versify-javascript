...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VersifyApi.TriggerScheduleConfiguration();
  });
  ...
  describe('TriggerScheduleConfiguration', function() {
    it('should create an instance of TriggerScheduleConfiguration', function() {
      ...
      //var instance = new VersifyApi.TriggerScheduleConfiguration();
      //expect(instance).to.be.a(VersifyApi.TriggerScheduleConfiguration);
    });
