# VersifylabsVersifyClient.MessagesApi
...
> Message createMessageV2MessagesPost(asset5, opts)
...
apiInstance.createMessageV2MessagesPost(asset5, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Message createMessageV2MessagesPost_0(asset5, opts)
...
apiInstance.createMessageV2MessagesPost_0(asset5, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Message updateMessageV2MessagesMessageIdPut(messageId, contact6, opts)
...
apiInstance.updateMessageV2MessagesMessageIdPut(messageId, contact6, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Message updateMessageV2MessagesMessageIdPut_0(messageId, contact6, opts)
...
apiInstance.updateMessageV2MessagesMessageIdPut_0(messageId, contact6, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
