...
> Note createNoteV2NotesPost(asset9, opts)
...
let apiInstance = new VersifyClient.NotesApi();
...
apiInstance.createNoteV2NotesPost(asset9, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Note createNoteV2NotesPost_0(asset9, opts)
...
apiInstance.createNoteV2NotesPost_0(asset9, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Note updateNoteV2NotesNoteIdPut(noteId, contact9, opts)
...
apiInstance.updateNoteV2NotesNoteIdPut(noteId, contact9, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Note updateNoteV2NotesNoteIdPut_0(noteId, contact9, opts)
...
apiInstance.updateNoteV2NotesNoteIdPut_0(noteId, contact9, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
