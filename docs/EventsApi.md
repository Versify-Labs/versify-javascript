# VersifylabsVersifyClient.EventsApi
...
> Event createEventV2EventsPost(asset3, opts)
...
apiInstance.createEventV2EventsPost(asset3, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Event createEventV2EventsPost_0(asset3, opts)
...
apiInstance.createEventV2EventsPost_0(asset3, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Event updateEventV2EventsEventIdPut(eventId, contact4, opts)
...
apiInstance.updateEventV2EventsEventIdPut(eventId, contact4, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Event updateEventV2EventsEventIdPut_0(eventId, contact4, opts)
...
apiInstance.updateEventV2EventsEventIdPut_0(eventId, contact4, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
